                ...
                <div class="col-sm-8">
                  <div class="banner banner-cat banner-badge">
                    ...
                    <a class="banner-link" href="#">
                      ...
                      <!-- End .banner-subtitle -->
                      <span class="banner-link-text">Shop Now</span> </a
                    ><!-- End .banner-link -->
                  </div>
                  <!-- End .banner -->
                </div>
                  ...
                  <div class="filter-item">
                    <div class="custom-control custom-checkbox">
                      <input
                        ...
                        id="cat-9"
                      />
                      <label class="custom-control-label" for="cat-9"
                        >Bags</label
                      >
                    </div>
                    <!-- End .custom-checkbox -->
                  ...
                  <div class="filter-item">
                    <div class="custom-control custom-checkbox">
                      <input
                        ...
                        id="cat-10"
                      />
                      <label class="custom-control-label" for="cat-10"
                        >Jackets</label
                      >
                    </div>
                    <!-- End .custom-checkbox -->
                  ...
                  <div class="filter-item">
                    <div class="custom-control custom-checkbox">
                      <input
                        ...
                        id="cat-11"
                      />
                      <label class="custom-control-label" for="cat-11"
                        >Shoes</label
                      >
                    </div>
                    <!-- End .custom-checkbox -->
                  ...
                  <div class="filter-item">
                    <div class="custom-control custom-checkbox">
                      <input
                        ...
                        id="cat-12"
                      />
                      <label class="custom-control-label" for="cat-12"
                        >Jumpers</label
                      >
                    </div>
                    <!-- End .custom-checkbox -->
                  ...
                  <div class="filter-item">
                    <div class="custom-control custom-checkbox">
                      <input
                        ...
                        id="cat-13"
                      />
                      <label class="custom-control-label" for="cat-13"
                        >Jeans</label
                      >
                    </div>
                    <!-- End .custom-checkbox -->
