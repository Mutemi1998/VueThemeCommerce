          ...
          <div class="row">
            <div class="col-md-6">
              <div class="product-gallery">
                <figure class="product-main-image">
                  ...
                  <img
                    id="product-zoom"
                    src="assets/images/products/single/masonry/1.jpg"
                    data-zoom-image="assets/images/products/single/masonry/1-big.jpg"
                    alt="product image"
                  />
                ...
                >
                  <a
                    ...
                    href="#"
                    data-image="assets/images/products/single/masonry/2.jpg"
                    data-zoom-image="assets/images/products/single/masonry/2-big.jpg"
                  >
                    <img
                      src="assets/images/products/single/masonry/2-small.jpg"
                      alt="product cross"
                    />
                  </a>

                  <a
                    class="product-gallery-item gallery-item-wide"
                    href="#"
                    data-image="assets/images/products/single/masonry/3.jpg"
                    data-zoom-image="assets/images/products/single/masonry/3-big.jpg"
                  >
                    <img
                      src="assets/images/products/single/masonry/3-small.jpg"
                  ...
                  <a
                    class="product-gallery-item"
                    href="#"
                    data-image="assets/images/products/single/masonry/4.jpg"
                    data-zoom-image="assets/images/products/single/masonry/4-big.jpg"
                  >
                    <img
                      src="assets/images/products/single/masonry/4-small.jpg"
                      alt="product side"
                    />
                  </a>
                </div>
            ...
            <div class="col-md-6">
              <div class="product-details sticky-content">
                <h1 class="product-title">Black denim dungaree dress</h1>
                <!-- End .product-title -->
                ...
                <div class="details-filter-row details-row-size">
                  ...
                  <div class="product-nav product-nav-thumbs">
                    <a href="#" class="active">
                      <img
                        src="assets/images/products/single/masonry/1-thumb.jpg"
                        alt="product desc"
                      />
                    </a>
                    <a href="#">
                      <img
                        src="assets/images/products/single/masonry/2-thumb.jpg"
                        alt="product desc"
                      />
                    </a>
                    <a href="#">
                      <img
                        src="assets/images/products/single/masonry/3-thumb.jpg"
                        alt="product desc"
                      />
                    </a>
                  </div>
                      ...
                      <div class="card-body">
                        <div class="product-desc-content">
                          <p>
                            ...
                            please view our <a href="#">Delivery information</a
                            ><br />
                            We hope you’ll love every purchase, but if you ever
                            need to return an item you can do so within a month
                            of receipt. For full details of how to make a
