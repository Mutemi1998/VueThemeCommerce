            ...
            <div class="col-md-6">
              <div class="product-gallery">
                <figure class="product-main-image">
                  <img
                    id="product-zoom"
                    src="assets/images/products/single/extended/3.jpg"
                    data-zoom-image="assets/images/products/single/extended/3-big.jpg"
                    alt="product image"
                  />
                ...
                <div id="product-zoom-gallery" class="product-image-gallery">
                  ...
                  >
                    <img
                      src="assets/images/products/single/extended/1-small.jpg"
                      alt="product side"
                    />
                  </a>
                  ...
                  <a
                    class="product-gallery-item"
                    href="#"
                    data-image="assets/images/products/single/extended/2.jpg"
                    data-zoom-image="assets/images/products/single/extended/2-big.jpg"
                  >
                    <img
                      src="assets/images/products/single/extended/2-small.jpg"
                      alt="product cross"
                    />
                  </a>
                  ...
                  <a
                    ...
                    href="#"
                    data-image="assets/images/products/single/extended/3.jpg"
                    data-zoom-image="assets/images/products/single/extended/3-big.jpg"
                  >
                    <img
                      src="assets/images/products/single/extended/3-small.jpg"
                  ...
                  <a
                    class="product-gallery-item"
                    href="#"
                    data-image="assets/images/products/single/extended/4.jpg"
                    data-zoom-image="assets/images/products/single/extended/4-big.jpg"
                  >
                    <img
                      src="assets/images/products/single/extended/4-small.jpg"
                      alt="product back"
                    />
                  </a>
                </div>
            ...
            <div class="col-md-6">
              <div class="product-details">
                <h1 class="product-title">
                  Yellow tie strap block heel sandals
                </h1>
                <!-- End .product-title -->
        ...
        <div class="tab-content">
          ...
          >
            <div class="product-desc-content">
              <div
                class="product-desc-row bg-image"
                style="
                  background-image: url('assets/images/products/single/extended/bg-1.jpg');
                "
              >
                <div class="container">
              ...
              <div
                class="product-desc-row bg-image text-white"
                style="
                  background-image: url('assets/images/products/single/extended/bg-2.jpg');
                "
              >
                <div class="container">
                  <div class="row">
              ...
              <div
                class="product-desc-row bg-image"
                style="
                  background-image: url('assets/images/products/single/extended/bg-3.jpg');
                "
              >
                <div class="container">
                  <div class="row">
                    <div class="col-lg-5">
                      <blockquote>
                        <p>
                          “ Everything is important - <br />that success is in
                          the details. ”
                        </p>
        ...
        >
          <div class="product product-7">
            ...
            <div class="product-body">
              ...
              <div class="product-nav product-nav-dots">
                <a href="#" class="active" style="background: #cc9966"
                  ><span class="sr-only">Color name</span></a
                >
          ...
          <div class="product product-7">
            ...
            <div class="product-body">
              ...
              <div class="product-nav product-nav-dots">
                <a href="#" class="active" style="background: #8b513d"
                  ><span class="sr-only">Color name</span></a
                >
                <a href="#" style="background: #333333"
                  ><span class="sr-only">Color name</span></a
