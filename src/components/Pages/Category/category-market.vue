          ...
          <div class="col-lg-9 col-xl-4-5col">
            ...
            >
              <div class="banner banner-poster">
                <a href="#">
                  <img
                    src="assets/images/demos/demo-13/banners/banner-7.jpg"
                    alt="Banner"
                  />
                </a>
              ...
              <div class="banner banner-poster">
                <a href="#">
                  <img
                    src="assets/images/demos/demo-13/banners/banner-8.jpg"
                    alt="Banner"
                  />
                </a>
            ...
            <div
              class="owl-carousel owl-simple owl-nav-align"
              data-toggle="owl"
              data-owl-options='{
                                    "nav": false, 
                                    "dots": true,
                ...
                <div class="col-6 col-md-4 col-lg-3">
                  <a href="category.html" class="cat-block">
                    <figure>
                      <span>
                        <img
                          src="assets/images/demos/demo-13/cats/cat-page/1.jpg"
                          alt="Category image"
                        />
                      </span>
                    </figure>
                ...
                <div class="col-6 col-md-4 col-lg-3">
                  <a href="category.html" class="cat-block">
                    <figure>
                      <span>
                        <img
                          src="assets/images/demos/demo-13/cats/cat-page/2.jpg"
                          alt="Category image"
                        />
                      </span>
                    </figure>
                ...
                <div class="col-6 col-md-4 col-lg-3">
                  <a href="category.html" class="cat-block">
                    <figure>
                      <span>
                        <img
                          src="assets/images/demos/demo-13/cats/cat-page/3.jpg"
                          alt="Category image"
                        />
                      </span>
                    </figure>
                ...
                <div class="col-6 col-md-4 col-lg-3">
                  <a href="category.html" class="cat-block">
                    <figure>
                      <span>
                        <img
                          src="assets/images/demos/demo-13/cats/cat-page/4.jpg"
                          alt="Category image"
                        />
                      </span>
                    </figure>
                ...
                <div class="col-6 col-md-4 col-lg-3">
                  <a href="category.html" class="cat-block">
                    <figure>
                      <span>
                        <img
                          src="assets/images/demos/demo-13/cats/cat-page/5.jpg"
                          alt="Category image"
                        />
                      </span>
                    </figure>
                ...
                <div class="col-6 col-md-4 col-lg-3">
                  <a href="category.html" class="cat-block">
                    <figure>
                      <span>
                        <img
                          src="assets/images/demos/demo-13/cats/cat-page/6.jpg"
                          alt="Category image"
                        />
                      </span>
                    </figure>
                ...
                <div class="col-6 col-md-4 col-lg-3">
                  <a href="category.html" class="cat-block">
                    <figure>
                      <span>
                        <img
                          src="assets/images/demos/demo-13/cats/cat-page/7.jpg"
                          alt="Category image"
                        />
                      </span>
                    </figure>
            ...
            <div class="sidebar sidebar-shop">
              ...
              <div class="widget widget-banner-sidebar">
                ...
                <div class="banner-sidebar banner-overlay">
                  <a href="#">
                    <img
                      src="assets/images/demos/demo-13/banners/banner-6.jpg"
                      alt="banner"
                    />
                  </a>
                </div>
