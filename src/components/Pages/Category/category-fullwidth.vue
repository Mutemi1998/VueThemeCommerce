            ...
            <div class="col-6 col-md-4 col-lg-4 col-xl-3 col-xxl-2">
              <div class="product">
                ...
                <div class="product-body">
                  ...
                  <h3 class="product-title">
                    <a href="product.html"
                      >Dark yellow lace cut out swing dress</a
                    >
                  </h3>
                  <!-- End .product-title -->
                  ...
                  <div class="product-nav product-nav-dots">
                    <a href="#" style="background: #ebebeb"
                      ><span class="sr-only">Color name</span></a
                    >
                    <a href="#" class="active" style="background: #eabc4e"
                      ><span class="sr-only">Color name</span></a
                    >
                  </div>
                  <!-- End .product-nav -->
            ...
            <div class="col-6 col-md-4 col-lg-4 col-xl-3 col-xxl-2">
              <div class="product">
                ...
                <div class="product-body">
                  ...
                  <div class="product-nav product-nav-dots">
                    <a href="#" class="active" style="background: #d8c5b0"
                      ><span class="sr-only">Color name</span></a
                    >
                    <a href="#" style="background: #333333"
                      ><span class="sr-only">Color name</span></a
            ...
            <div class="col-6 col-md-4 col-lg-4 col-xl-3 col-xxl-2">
              <div class="product">
                ...
                <div class="product-body">
                  ...
                  <div class="product-nav product-nav-dots">
                    <a href="#" class="active" style="background: #e07a3d"
                      ><span class="sr-only">Color name</span></a
                    >
                    <a href="#" style="background: #7b5d36"
                      ><span class="sr-only">Color name</span></a
            ...
            <div class="col-6 col-md-4 col-lg-4 col-xl-3 col-xxl-2">
              <div class="product">
                ...
                <div class="product-body">
                  ...
                  <h3 class="product-title">
                    <a href="product.html"
                      >Light brown studded Wide fit wedges</a
                    >
                  </h3>
                  <!-- End .product-title -->
