                ...
                <div class="product product-7 text-center">
                    <figure class="product-media">
                      ...
                      <div class="product-action-vertical">
                        ...
                        >
                        <a
                          :href="'popup/quickView.html?id=' + product.id"
                    ...
                    <div class="product-body">
                      ...
                      <div class="ratings-container">
                        <div class="ratings">
                          <div class="ratings-val" :style="{ width: (product.rating.rate * 10) + '%' }"></div>
                          <!-- End .ratings-val -->
                        </div>
                        <!-- End .ratings -->
                        <span class="ratings-text">( {{ product.rating.count }} Reviews )</span>
                      </div>
...
<script>
import { getAllProducts } from "@/api.vue";
...
export default {
  ...
  methods: {
    async fetchProducts() {
      try {
        this.products = await getAllProducts(); // Fetch all products
      } catch (error) {
        console.log(error);
