      ...
      <div class="container">
        <nav class="blog-nav">
          <ul class="menu-cat entry-filter justify-content-center">
            <li class="active">
              <a href="#" data-filter="*">All Blog Posts<span>8</span></a>
            </li>
            <li>
            ...
            <li>
              <a href="#" data-filter=".travel">Travel<span>3</span></a>
            </li>
            <li>
              ...
              <div class="entry-body">
                ...
                <div class="entry-content">
                  <p>
                    ...
                    Vestibulumvo lutpat, lacus a ultrices sagittis ...
                  </p>
                  <a href="single.html" class="read-more">Continue Reading</a>
                </div>
                <!-- End .entry-content -->
              ...
              <div class="entry-body">
                ...
                <div class="entry-content">
                  <p>
                    ...
                    luctus, metus. Phasellus ultrices nulla quis ...
                  </p>
                  <a href="single.html" class="read-more">Continue Reading</a>
                </div>
                <!-- End .entry-content -->
