      ...
      <div class="container">
        <nav class="blog-nav">
          <ul class="menu-cat entry-filter justify-content-center">
            <li class="active">
              <a href="#" data-filter="*">All Blog Posts<span>12</span></a>
            </li>
            <li>
            ...
            <li>
              <a href="#" data-filter=".fashion">Fashion<span>1</span></a>
            </li>
            <li>
              <a href="#" data-filter=".travel">Travel<span>2</span></a>
            </li>
            <li>
          ...
          <div class="entry-item lifestyle shopping col-sm-6">
            <article class="entry entry-grid text-center">
              <figure class="entry-media">
                <a href="single.html">
                  <img
                    src="assets/images/blog/grid/2cols/post-1.jpg"
                    alt="image desc"
                  />
                </a>
              </figure>
          ...
          <div class="entry-item lifestyle col-sm-6">
            <article class="entry entry-grid text-center">
              <figure class="entry-media entry-video">
                <a href="single.html">
                  <img
                    src="assets/images/blog/grid/2cols/post-2.jpg"
                    alt="image desc"
                  />
                </a>
              </figure>
            ...
            <article class="entry entry-grid text-center">
              <figure class="entry-media">
                ...
                >
                  <a href="single.html">
                    <img
                      src="assets/images/blog/grid/2cols/post-3.jpg"
                      alt="image desc"
                    />
                  </a>
                  <a href="single.html">
          ...
          <div class="entry-item travel col-sm-6">
            <article class="entry entry-grid text-center">
              <figure class="entry-media">
                <a href="single.html">
                  <img
                    src="assets/images/blog/grid/2cols/post-4.jpg"
                    alt="image desc"
                  />
                </a>
              </figure>
          ...
          <div class="entry-item travel hobbies col-sm-6">
            <article class="entry entry-grid text-center">
              <figure class="entry-media">
                <a href="single.html">
                  <img
                    src="assets/images/blog/grid/2cols/post-5.jpg"
                    alt="image desc"
                  />
                </a>
              </figure>
          ...
          <div class="entry-item hobbies col-sm-6">
            <article class="entry entry-grid text-center">
              <figure class="entry-media">
                <a href="single.html">
                  <img
                    src="assets/images/blog/grid/2cols/post-6.jpg"
                    alt="image desc"
                  />
                </a>
              </figure>
