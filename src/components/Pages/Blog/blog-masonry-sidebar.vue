              ...
              <div class="entry-item col-sm-6">
                <article class="entry entry-grid text-center">
                  <figure class="entry-media">
                    <a href="single.html">
                      <img
                        src="assets/images/blog/masonry/with-sidebar/post-1.jpg"
                        alt="image desc"
                      />
                    </a>
                  </figure>
              ...
              <div class="entry-item col-sm-6">
                <article class="entry entry-grid text-center">
                  <figure class="entry-media">
                    <a href="single.html">
                      <img
                        src="assets/images/blog/masonry/with-sidebar/post-2.jpg"
                        alt="image desc"
                      />
                    </a>
                  </figure>
              ...
              <div class="entry-item col-sm-6">
                <article class="entry entry-grid text-center">
                  <figure class="entry-media">
                    <a href="single.html">
                      <img
                        src="assets/images/blog/masonry/with-sidebar/post-3.jpg"
                        alt="image desc"
                      />
                    </a>
                  </figure>
              ...
              <div class="entry-item col-sm-6">
                <article class="entry entry-grid text-center">
                  <figure class="entry-media entry-video">
                    <a href="single.html">
                      <img
                        src="assets/images/blog/masonry/with-sidebar/post-4.jpg"
                        alt="image desc"
                      />
                    </a>
                  </figure>
              ...
              <div class="entry-item col-sm-6">
                <article class="entry entry-grid text-center">
                  <figure class="entry-media">
                    <a href="single.html">
                      <img
                        src="assets/images/blog/masonry/with-sidebar/post-5.jpg"
                        alt="image desc"
                      />
                    </a>
                  </figure>
              ...
              <div class="entry-item col-sm-6">
                <article class="entry entry-grid text-center">
                  <figure class="entry-media">
                    <a href="single.html">
                      <img
                        src="assets/images/blog/masonry/with-sidebar/post-6.jpg"
                        alt="image desc"
                      />
                    </a>
                  </figure>
              ...
              <div class="entry-item col-sm-6">
                <article class="entry entry-grid text-center">
                  <figure class="entry-media">
                    <a href="single.html">
                      <img
                        src="assets/images/blog/masonry/with-sidebar/post-7.jpg"
                        alt="image desc"
                      />
                    </a>
                  </figure>
                  ...
                  <div class="entry-body">
                    ...
                    <h2 class="entry-title">
                      <a href="single.html"
                        >Aenean dignissim pellente squefelis.</a
                      >
                    </h2>
                    <!-- End .entry-title -->
                ...
                <article class="entry entry-grid text-center">
                  <figure class="entry-media">
                    ...
                    >
                      <a href="single.html">
                        <img
                          src="assets/images/blog/masonry/with-sidebar/post-8.jpg"
                          alt="image desc"
                        />
                      </a>
                      <a href="single.html">
                        <img
                          src="assets/images/blog/masonry/with-sidebar/post-8-2.jpg"
                          alt="image desc"
                        />
                      </a>
                    </div>
          ...
          <aside class="col-lg-3">
            <div class="sidebar">
              ...
              <div class="widget widget-cats">
                ...
                <ul>
                  <li>
                    <a href="#">Lifestyle<span>3</span></a>
                  </li>
                  <li>
                    <a href="#">Shopping<span>3</span></a>
                  </li>
                  <li>
                    <a href="#">Fashion<span>1</span></a>
                  </li>
                  <li>
                    <a href="#">Travel<span>3</span></a>
                  </li>
                  <li>
                    <a href="#">Hobbies<span>2</span></a>
                  </li>
                </ul>
              </div>
              <!-- End .widget -->
