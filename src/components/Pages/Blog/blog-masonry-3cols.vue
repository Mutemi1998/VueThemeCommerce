      ...
      <div class="container">
        <nav class="blog-nav">
          <ul class="menu-cat entry-filter justify-content-center">
            ...
            <li>
              <a href="#" data-filter=".lifestyle">Lifestyle<span>3</span></a>
            </li>
            <li>
              <a href="#" data-filter=".shopping">Shopping<span>1</span></a>
            </li>
            <li>
              <a href="#" data-filter=".fashion">Fashion<span>2</span></a>
            </li>
            <li>
              <a href="#" data-filter=".travel">Travel<span>4</span></a>
            </li>
            <li>
              <a href="#" data-filter=".hobbies">Hobbies<span>2</span></a>
            </li>
          </ul>
          <!-- End .blog-menu -->
        </nav>
          ...
          <div class="entry-item lifestyle shopping col-sm-6 col-lg-4">
            <article class="entry entry-grid text-center">
              <figure class="entry-media">
                <a href="single.html">
                  <img
                    src="assets/images/blog/masonry/3cols/post-1.jpg"
                    alt="image desc"
                  />
                </a>
              </figure>
          ...
          <div class="entry-item lifestyle col-sm-6 col-lg-4">
            <article class="entry entry-grid text-center">
              <figure class="entry-media">
                <a href="single.html">
                  <img
                    src="assets/images/blog/masonry/3cols/post-2.jpg"
                    alt="image desc"
                  />
                </a>
              </figure>
              ...
              <div class="entry-body">
                ...
                <div class="entry-cats">in <a href="#">Lifestyle</a></div>
                <!-- End .entry-cats -->
              </div>
              <!-- End .entry-body -->
            </article>
            ...
            <article class="entry entry-grid text-center">
              <figure class="entry-media">
                ...
                >
                  <a href="single.html">
                    <img
                      src="assets/images/blog/masonry/3cols/post-3.jpg"
                      alt="image desc"
                    />
                  </a>
                  <a href="single.html">
                    <img
                      src="assets/images/blog/masonry/3cols/post-3-2.jpg"
                      alt="image desc"
                    />
                  </a>
                </div>
          ...
          <div class="entry-item travel col-sm-6 col-lg-4">
            <article class="entry entry-grid text-center">
              <figure class="entry-media entry-video">
                <a href="single.html">
                  <img
                    src="assets/images/blog/masonry/3cols/post-4.jpg"
                    alt="image desc"
                  />
                </a>
              </figure>
              ...
              <div class="entry-body">
                ...
                <div class="entry-cats">in <a href="#">Travel</a></div>
                <!-- End .entry-cats -->
              </div>
              <!-- End .entry-body -->
            </article>
          ...
          <div class="entry-item travel hobbies col-sm-6 col-lg-4">
            <article class="entry entry-grid text-center">
              <figure class="entry-media">
                <a href="single.html">
                  <img
                    src="assets/images/blog/masonry/3cols/post-5.jpg"
                    alt="image desc"
                  />
                </a>
              </figure>
          ...
          <div class="entry-item hobbies col-sm-6 col-lg-4">
            <article class="entry entry-grid text-center">
              <figure class="entry-media">
                <a href="single.html">
                  <img
                    src="assets/images/blog/masonry/3cols/post-6.jpg"
                    alt="image desc"
                  />
                </a>
              </figure>
              ...
              <div class="entry-body">
                ...
                <div class="entry-cats">in <a href="#">Hobbies</a></div>
                <!-- End .entry-cats -->
              </div>
              <!-- End .entry-body -->
            </article>
          ...
          <div class="entry-item travel col-sm-6 col-lg-4">
            <article class="entry entry-grid text-center">
              <figure class="entry-media">
                <a href="single.html">
                  <img
                    src="assets/images/blog/masonry/3cols/post-7.jpg"
                    alt="image desc"
                  />
                </a>
              </figure>
          ...
          <div class="entry-item fashion col-sm-6 col-lg-4">
            <article class="entry entry-grid text-center">
              <figure class="entry-media">
                <a href="single.html">
                  <img
                    src="assets/images/blog/masonry/3cols/post-8.jpg"
                    alt="image desc"
                  />
                </a>
              </figure>
              ...
              <div class="entry-body">
                ...
                <div class="entry-cats">in <a href="#">Fashion</a></div>
                <!-- End .entry-cats -->
              </div>
              <!-- End .entry-body -->
            </article>
            ...
            <article class="entry entry-grid text-center">
              <figure class="entry-media">
                ...
                >
                  <a href="single.html">
                    <img
                      src="assets/images/blog/masonry/3cols/post-9.jpg"
                      alt="image desc"
                    />
                  </a>
                  <a href="single.html">
                    <img
                      src="assets/images/blog/masonry/3cols/post-9-2.jpg"
                      alt="image desc"
                    />
                  </a>
                </div>
