        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="product product-2">
            ...
            <div class="product-body">
              ...
              <h3 class="product-title">
                <a href="product.html"
                  >GoPro - HERO7 Black HD Waterproof Action</a
                >
              </h3>
              <!-- End .product-title -->
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="product product-2">
            ...
            <div class="product-body">
              ...
              <h3 class="product-title">
                <a href="product.html"
                  >Apple - Apple Watch Series 3 with White Sport Band</a
                >
              </h3>
              <!-- End .product-title -->
              <div class="product-price">$214.49</div>
              <!-- End .product-price -->
              <div class="ratings-container">
                <div class="ratings">
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="product product-2">
            ...
            <div class="product-body">
              ...
              <!-- End .product-cat -->
              <h3 class="product-title">
                <a href="product.html">Sony - Alpha a5100 Mirrorless Camera</a>
              </h3>
              <!-- End .product-title -->
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="product product-2">
            ...
            <div class="product-body">
              ...
              <h3 class="product-title">
                <a href="product.html"
                  >Home Mini - Smart Speaker with Google Assistant</a
                >
              </h3>
              <!-- End .product-title -->
              ...
              <div class="product-nav product-nav-dots">
                <a href="#" class="active" style="background: #ef837b"
                  ><span class="sr-only">Color name</span></a
                >
                <a href="#" style="background: #333333"
                  ><span class="sr-only">Color name</span></a
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="product product-2">
            ...
            <div class="product-body">
              ...
              <!-- End .product-cat -->
              <h3 class="product-title">
                <a href="product.html">WONDERBOOM Portable Bluetooth Speaker</a>
              </h3>
              <!-- End .product-title -->
              <div class="product-price">
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="product product-2">
            ...
            <div class="product-body">
              ...
              <h3 class="product-title">
                <a href="product.html"
                  >Google - Home Hub with Google Assistant</a
                >
              </h3>
              <!-- End .product-title -->
